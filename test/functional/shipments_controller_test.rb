...
class ShipmentsControllerTest < ActionController::TestCase
  ...
  test "should create shipment" do
    assert_difference('Shipment.count') do
      post :create, shipment: { id: @shipment.id, shipment_date: @shipment.shipment_date, shipped: @shipment.shipped }
    end
  ...
  test "should update shipment" do
    put :update, id: @shipment, shipment: { id: @shipment.id, shipment_date: @shipment.shipment_date, shipped: @shipment.shipped }
    assert_redirected_to shipment_path(assigns(:shipment))
  end
